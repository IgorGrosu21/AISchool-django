...
from .manual import BalanceSerializer, ModuleWithManualSerializer, ModuleSerializer, ManualSerializer, TaskSerializer, TopicSerializer
from .person import ParentSerializer, StudentSerializer, StudentWithKlassSerializer, SubscriptionSerializer, TeacherSerializer
